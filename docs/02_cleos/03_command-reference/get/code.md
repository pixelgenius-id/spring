...
## Examples
Simply output the hash of vex.token contract 

```sh
cleos get code vex.token
```
```console
code hash: f675e7aeffbf562c033acfaf33eadff255dacb90d002db51c7ad7cbf057eb791
```

Retrieve and save abi for vex.token contract

```sh
cleos get code vex.token -a vex.token.abi
```
```console
code hash: f675e7aeffbf562c033acfaf33eadff255dacb90d002db51c7ad7cbf057eb791
saving abi to vex.token.abi
```

Retrieve and save wast code for vex.token contract

```sh
cleos get code vex.token -c vex.token.wast
```
```console
code hash: f675e7aeffbf562c033acfaf33eadff255dacb90d002db51c7ad7cbf057eb791
saving wast to vex.token.wast
```
